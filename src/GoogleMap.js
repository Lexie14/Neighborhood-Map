    ...
    return (
      ...
      >
        ...
        <InfoWindow
          ...
          position={{
            lat: parseFloat(this.props.infoPosition.lat),
            lng: parseFloat(this.props.infoPosition.lng)
          }}
        ...
        >
          <div>
            <div className="info-window" role="Dialog">
              <p tabIndex="0">
                <span>Name:</span> {this.props.selectedPlace.name}
              </p>
              <p tabIndex="0">
                <span>Type:</span>{" "}
              ...
              <p tabIndex="0">
                ...
                {!this.props.selectedPlace.postalCode
                  ? "N/A"
                  : this.props.selectedPlace.postalCode}
              </p>
              <p tabIndex="0">
